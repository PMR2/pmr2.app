...
class IExposureDownloadTool(zope.interface.Interface):
    """
    ...
    def get_download_link(exposure_object):
        """
        Return a download link if this tool is enabled for this object.
        """

    def download(exposure_object, request):
        """
